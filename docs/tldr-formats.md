...
Un file inbox è **per cappello** e ogni checkpoint lo riscrive: il perimetro va allargato
man mano che il file cresce, nominando le materie invece delle singole nozioni. È l'unico
modo di restare sotto i 600 char quando le nozioni aggregate sono venti, e la perdita di
grana è voluta — a decidere *se aprire* basta sapere che l'area è toccata.
