...
In clessidra e al trasloco si applicano SOLO i criteri indipendenti, quelli che si leggono nella frase. Eco, calco, inventario, sorpresa, «è già scritto altrove» e la scelta del layer dipendono da codice, fonte viva o resto della doc: li paga il drain, non la transizione.
...
Le nozioni che emergono si appendono a ## Doc Impact del task file, e lì restano VIVE (clessidra): riscrivile o eliminale quando il codice le smentisce, nessun marker di esito. Scrivi il fatto per esteso — il perché, e le condizioni in cui vale — mai compresso in un aforisma: chi lo smaltisce non ha in memoria la conversazione che lo ha prodotto, e da una frase ellittica non può ricostruirlo. La ridondanza ammessa è FRA voci: ripetere un fatto già scritto altrove va bene, gonfiare la singola voce di cronaca o di cornice no. Il trasloco in inbox è del checkpoint — al rilascio o alla chiusura, subito per le nozioni di mondo.
